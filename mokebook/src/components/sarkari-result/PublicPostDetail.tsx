      ...
      <div className="mb-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          {items.map((item, i) => (
            <div
              key={i}
              className={`p-4 ${i > 0 ? "border-t border-gray-200 dark:border-gray-700" : ""}`}
            >
              {render(item)}
            </div>
          ))}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          ...
          <Link href="/sarkari-result" className="text-blue-600">
            ← Back to Home
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className="px-3 py-1.5 bg-blue-600 text-white text-xs rounded-lg flex items-center gap-1"
          >
            <Share2 className="w-3 h-3" /> Share
          </button>
          <button
            onClick={() => window.print()}
            className="px-3 py-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs rounded-lg flex items-center gap-1"
          >
