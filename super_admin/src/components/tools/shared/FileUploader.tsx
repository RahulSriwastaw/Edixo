      ...
      <motion.div
        ...
        className={cn(
          ...
          isDragActive 
            ...
            : 'border-[var(--border-input)] bg-white hover:border-primary/50 hover:bg-[var(--bg-sidebar)]/50',
      ...
      >
        ...
        <label htmlFor="fileInput" className="cursor-pointer flex flex-col items-center gap-6">
          <div className={cn(
            ...
            isDragActive ? 'bg-primary text-white scale-110 shadow-lg shadow-primary/30' : 'bg-slate-100 text-[var(--text-muted)] group-hover:bg-primary/10 group-hover:text-primary'
          )}>
          ...
          <div className="flex items-center gap-4 pt-4">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 rounded-full text-sm font-medium text-[var(--text-secondary)]">
