    ...
    <div className="border rounded-lg overflow-hidden">
      <div className="flex items-center gap-1 p-2 bg-[var(--bg-main)] border-b flex-wrap">
        {toolbarButtons.map((btn, idx) => {
          if (btn.divider) {
            return <div key={idx} className="w-px h-6 bg-[var(--bg-sidebar)] mx-1" />;
          }
          const Icon = btn.icon;
          return (
            <Button
      ...
      <div className="min-h-screen bg-neutral-bg">
        ...
        <div className={cn("flex flex-col min-h-screen transition-all duration-300", isOpen ? "md:ml-60" : "ml-0")}>
          ...
          <main className="flex-1 p-6 flex items-center justify-center">
            <div className="text-[var(--text-secondary)]">Loading post...</div>
          </main>
        </div>
      </div>
    );
          ...
          <div className="max-w-[1600px] mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Link href="/admin/blog" className="p-2 hover:bg-[var(--bg-main)] rounded-lg transition-colors">
