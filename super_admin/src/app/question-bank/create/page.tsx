          ...
          <div className="max-w-[1600px] mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[var(--text-primary)]">Create Question</h1>
                  <p className="text-[var(--text-secondary)] text-sm mt-1">Add a bilingual question with Hindi & English content</p>
                </div>
              </div>
