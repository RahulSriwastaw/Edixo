    ...
    <div className="animate-fade-in" style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {options.map((opt, i) => (
                <div key={opt.id} style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                  ...
                  <input className="db-input" style={{ flex: 1 }} placeholder={`Option ${opt.id} (English)`}
        ...
        <div className="db-card">
          ...
          <textarea className="db-input" style={{ minHeight: 60 }} placeholder="Explanation (English)"
            value={form.explanationEn} onChange={e => setForm({ ...form, explanationEn: e.target.value })} />
          <div style={{ marginTop: 8 }}>
            <textarea className="db-input" style={{ minHeight: 60 }} placeholder="Explanation (Hindi)"
