...
async function check() {
    try {
        ...
        // Try with GK-ORG-00001
        const res2 = await axios.get('http://localhost:4000/api/mockbook/analytics/stats?orgId=GK-ORG-00001', config);
        console.log('GK-ORG-00001 Stats:', res2.data.data);
    } catch (e: any) {
